...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<ViewCustomerInfo> ViewCustomerInfos { get; set; }

    public virtual DbSet<ViewTotalProductCount> ViewTotalProductCounts { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-5789TGK\\MSSQL2022;Initial Catalog=NORTHWIND;User Id=sa;Password=123qweasdzxc..;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomerTotal>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CustomerTotal");
            ...
            entity.Property(e => e.CustomerId)
                ...
                .IsFixedLength()
                .HasColumnName("CustomerID");
            entity.Property(e => e.CustomerTotal1).HasColumnName("CustomerTotal");
        });
        ...
        modelBuilder.Entity<EmployeeManager>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("EmployeeManager");

            entity.Property(e => e.EmployeeFullName).HasMaxLength(31);
            entity.Property(e => e.EmployeeId).HasColumnName("EmployeeID");
            entity.Property(e => e.Manager).HasMaxLength(31);
        ...
        modelBuilder.Entity<ViewCustomer>(entity =>
        {
            ...
            entity.Property(e => e.CompanyName).HasMaxLength(40);
            entity.Property(e => e.ContactTİtle).HasMaxLength(30);
            entity.Property(e => e.CustomerId)
                .HasMaxLength(5)
                .IsFixedLength()
                .HasColumnName("CustomerID");
        ...
        modelBuilder.Entity<ViewCustomerInfo>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ViewCustomerInfo");

            entity.Property(e => e.CustomerId)
                .HasMaxLength(5)
                .IsFixedLength()
                .HasColumnName("CustomerID");
            entity.Property(e => e.CustomerInfo).HasMaxLength(73);
        });

        modelBuilder.Entity<ViewTotalProductCount>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_TotalProductCOunt");
